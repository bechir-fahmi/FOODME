...
public class DefaultMealVendorTypes : IEntityTypeConfiguration<VendorMealTypeEntity>
{
    public void Configure(EntityTypeBuilder<VendorMealTypeEntity> builder)
    {
        builder.HasData(
                new VendorMealTypeEntity()
                {
