...
public class DefaultVendorMealTimings : IEntityTypeConfiguration<VendorMealTimingEntity>
{
    public void Configure(EntityTypeBuilder<VendorMealTimingEntity> builder)
    {
        builder.HasData(
                new VendorMealTimingEntity()
                {
